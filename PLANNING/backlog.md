...
## P2 — Should Fix Before Launch (Hotfix-3 post-audit deferrals)
- [ ] Hotfix-3 R2: create `testing/test_account_lifecycle.py` to formalize regression coverage of password reset + account deletion flows. Per Inquisitor post-audit, currently covered by integration smoke + `stress_probe.py`; recommended as a dedicated test task in Sprint 5 Ops or as an H4 add-on.
